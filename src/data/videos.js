...
export const videos = [
  {
    ...
    comments_data: [
      ...
      { id: "c8", user: "xvnzqmkb", avatar: "", text: "Stumbled upon this and genuinely cannot function 😭 she is so unreal I've been on loop for hours", likes: 312, time: "3일 전",
        replies: [
          { id: "r1", user: "jlhqmntx", avatar: "", text: "Same omg I had plans today and now look at me 💀", likes: 78, time: "3일 전" },
          { id: "r2", user: "rqkzmxvb", avatar: "", text: "why is she so perfect 😭 I need her whole discography NOW", likes: 45, time: "2일 전" },
        ],
      },
      ...
      { id: "c12", user: "fzxqknvr", avatar: "", text: "How is nobody talking about how insane this stage presence is?? 🫠 I've watched 40+ kpop clips this week and this is different", likes: 234, time: "2일 전",
        replies: [
          { id: "r1", user: "kqxvnzmb", avatar: "", text: "SAME she just has something that can't be taught 🔥", likes: 67, time: "2일 전" },
          { id: "r2", user: "wznqxvkm", avatar: "", text: "I literally cannot look away it's insane 😭", likes: 34, time: "1일 전" },
        ],
      },
      ...
      { id: "c14", user: "dxqnvkzm", avatar: "", text: "팬사인회에서 실물 봤는데 ㄹㅇ 영상이 실물의 절반도 못 담은 거 맞음😭 실제로 보면 진짜 기절함", likes: 512, time: "1일 전",
        replies: [
          { id: "r1", user: "hqxzmkvn", avatar: "", text: "부럽습니다ㅠ 저는 추첨에서 계속 떨어져서... 언젠간 꼭", likes: 67, time: "1일 전" },
        ],
      },
      ...
      { id: "c17", user: "cqkxvtnm", avatar: "", text: "日本からです！세현さんが本当に大好き😭 いつもここで元気をもらっています", likes: 156, time: "23시간 전",
        replies: [
          { id: "r1", user: "gxnzbqkv", avatar: "", text: "일본에서도 세현 팬이 있다니 반가워요 🥹", likes: 34, time: "22시간 전" },
          { id: "r2", user: "wxbmqrtz", avatar: "", text: "International fans unite!! 🌍 Sehyeon deserves the world", likes: 23, time: "21시간 전" },
        ],
      },
      ...
      { id: "c24", user: "pqrxknzv", avatar: "", text: "완성형 아이돌이다 ㄹㅇ 비주얼 실력 퍼포 다 갖춘 거 이런 거 얼마만에 보는 건지", likes: 423, time: "16시간 전", replies: [] },
      ...
      { id: "c28", user: "lxqnvzmb", avatar: "", text: "자야 되는데 계속 돌려봄ㅠ 오늘 몇 번째 보는 건지 이거 수면 방해 영상임", likes: 67, time: "12시간 전", replies: [] },
      ...
      { id: "c31", user: "dqxvnzbm", avatar: "", text: "피지컬이 말이 안 됨 저 키에 저 비율에 저 얼굴까지 이게 사람임? 🫠", likes: 201, time: "9시간 전",
        replies: [
          { id: "r1", user: "wqxvnzbm", avatar: "", text: "ㄹㅇ 현실에 존재하는 게 신기한 레벨이잖아", likes: 34, time: "8시간 전" },
        ],
      },
      ...
      { id: "c33", user: "xmqvbnzk", avatar: "", text: "또 봄 오늘만 다섯 번째임 이거 중독성 실화냐 진짜", likes: 34, time: "7시간 전", replies: [] },
